<?php
 ...
 return [
    ...
    "rules_text" => "<strong>Notice:</strong> Words prefixed with a colon (&quot;:word&quot;) must not be translated, that word will be replaced with a certain value inside the application.",
