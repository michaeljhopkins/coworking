			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<form class="form-horizontal" role="form" method="POST" action="{{ url('/auth/login') }}">
						...
						<div class="form-group">
							<div class="col-md-6 col-md-offset-4">
								<button type="submit" class="btn btn-primary ladda-button" data-style="zoom-in"><span class="ladda-label">{{ trans('auth.login') }}</span></button>

								<a class="btn btn-link" href="{{ url('/password/email') }}">{{ trans('auth.forgot_password_question') }}</a>
							</div>
						</div>
					</form>
				</div>
